...
for (data_path in nli_overview_data_paths) {
  ...
  cat(
    ...
    "threshold, stacked) — in the label-distribution panel, the confidence ",
    "panel (with a dashed line marking the threshold), and the alignment ",
    "panel. Mean/median confidence and the % meeting the threshold are ",
