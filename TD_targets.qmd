...
disk to allow un-parking. See [TD_LLM_approach.qmd](TD_LLM_approach.html) for design
and [TD_NLI_LLM_two_phase.qmd](TD_NLI_LLM_two_phase.html) for the planned two-phase
extension.
